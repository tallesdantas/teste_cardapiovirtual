...
// version: 2.1.3
(function(d,f,a){a.registerNamespace("Code.PhotoSwipe.Image");d.Code.PhotoSwipe.Image.EventTypes={onLoad:"onLoad",onError:"onError"}})(window,window.klass,window.Code.Util);
(function(d,f,a){a.registerNamespace("Code.PhotoSwipe.Image");var b=d.Code.PhotoSwipe;b.Image.ImageClass=f({refObj:null,imageEl:null,src:null,caption:null,metaData:null,imageLoadHandler:null,imageErrorHandler:null,dispose:function(){var c;this.shrinkImage();for(c in this)a.objectHasProperty(this,c)&&(this[c]=null)},initialize:function(a,h,b,i){this.refObj=a;this.src=this.originalSrc=h;this.caption=b;this.metaData=i;this.imageEl=new d.Image;this.imageLoadHandler=this.onImageLoad.bind(this);this.imageErrorHandler=
...
(function(d,f,a){a.registerNamespace("Code.PhotoSwipe.Cache");d=d.Code.PhotoSwipe;d.Cache.Mode={normal:"normal",aggressive:"aggressive"};d.Cache.Functions={getImageSource:function(a){return a.href},getImageCaption:function(b){if(b.nodeName==="IMG")return a.DOM.getAttribute(b,"alt");var c,h,e;c=0;for(h=b.childNodes.length;c<h;c++)if(e=b.childNodes[c],b.childNodes[c].nodeName==="IMG")return a.DOM.getAttribute(e,"alt")},getImageMetaData:function(){return{}}}})(window,window.klass,window.Code.Util);
(function(d,f,a,b){a.registerNamespace("Code.PhotoSwipe.Cache");var c=d.Code.PhotoSwipe;c.Cache.CacheClass=f({images:null,settings:null,dispose:function(){var c,b,d;if(!a.isNothing(this.images)){b=0;for(d=this.images.length;b<d;b++)this.images[b].dispose();this.images.length=0}for(c in this)a.objectHasProperty(this,c)&&(this[c]=null)},initialize:function(a,c){var d,f,g,k,l,m;this.settings=c;this.images=[];d=0;for(f=a.length;d<f;d++)g=a[d],k=this.settings.getImageSource(g),l=this.settings.getImageCaption(g),
m=this.settings.getImageMetaData(g),this.images.push(new b.ImageClass(g,k,l,m))},getImages:function(b){var e,d,f=[],g;e=0;for(d=b.length;e<d;e++){g=this.images[b[e]];if(this.settings.cacheMode===c.Cache.Mode.aggressive)g.cacheDoNotShrink=!0;f.push(g)}if(this.settings.cacheMode===c.Cache.Mode.aggressive){e=0;for(d=this.images.length;e<d;e++)g=this.images[e],a.objectHasProperty(g,"cacheDoNotShrink")?delete g.cacheDoNotShrink:g.shrinkImage()}return f}})})(window,window.klass,window.Code.Util,window.Code.PhotoSwipe.Image);
(function(d,f,a){a.registerNamespace("Code.PhotoSwipe.DocumentOverlay");d.Code.PhotoSwipe.DocumentOverlay.CssClasses={documentOverlay:"ps-document-overlay"}})(window,window.klass,window.Code.Util);
(function(d,f,a){a.registerNamespace("Code.PhotoSwipe.DocumentOverlay");var b=d.Code.PhotoSwipe;b.DocumentOverlay.DocumentOverlayClass=f({el:null,settings:null,initialBodyHeight:null,dispose:function(){var c;a.Animation.stop(this.el);a.DOM.removeChild(this.el,this.el.parentNode);for(c in this)a.objectHasProperty(this,c)&&(this[c]=null)},initialize:function(c){this.settings=c;this.el=a.DOM.createElement("div",{"class":b.DocumentOverlay.CssClasses.documentOverlay},"");a.DOM.setStyle(this.el,{display:"block",
...
window.klass,window.Code.Util);
(function(d,f,a){a.registerNamespace("Code.PhotoSwipe.Carousel");var b=d.Code.PhotoSwipe;b.Carousel.CarouselClass=f({el:null,contentEl:null,settings:null,cache:null,slideByEndHandler:null,currentCacheIndex:null,isSliding:null,isSlideshowActive:null,lastSlideByAction:null,touchStartPoint:null,touchStartPosition:null,imageLoadHandler:null,imageErrorHandler:null,slideshowTimeout:null,dispose:function(){var c;this.stopSlideshow();a.Animation.stop(this.el);a.DOM.removeChild(this.el,this.el.parentNode);
for(c in this)a.objectHasProperty(this,c)&&(this[c]=null)},initialize:function(c,h){var e,d,f;this.cache=c;this.settings=h;this.slideByEndHandler=this.onSlideByEnd.bind(this);this.imageLoadHandler=this.onImageLoad.bind(this);this.imageErrorHandler=this.onImageError.bind(this);this.currentCacheIndex=0;this.isSlideshowActive=this.isSliding=!1;if(this.cache.images.length<3)this.settings.loop=!1;this.el=a.DOM.createElement("div",{"class":b.Carousel.CssClasses.carousel},"");a.DOM.setStyle(this.el,{display:"block",
position:"absolute",left:0,top:0,overflow:"hidden",zIndex:this.settings.zIndex});a.DOM.hide(this.el);this.contentEl=a.DOM.createElement("div",{"class":b.Carousel.CssClasses.content},"");a.DOM.setStyle(this.contentEl,{display:"block",position:"absolute",left:0,top:0});a.DOM.appendChild(this.contentEl,this.el);d=c.images.length<3?c.images.length:3;for(e=0;e<d;e++)f=a.DOM.createElement("div",{"class":b.Carousel.CssClasses.item+" "+b.Carousel.CssClasses.item+"-"+e},""),a.DOM.setAttribute(f,"style","float: left;"),
a.DOM.setStyle(f,{display:"block",position:"relative",left:0,top:0,overflow:"hidden"}),this.settings.margin>0&&a.DOM.setStyle(f,{marginRight:this.settings.margin+"px"}),a.DOM.appendChild(f,this.contentEl);a.DOM.appendToBody(this.el)},resetPosition:function(){var c=a.DOM.windowWidth(),h=a.DOM.windowHeight(),e=this.settings.margin>0?c+this.settings.margin:c,d=a.DOM.find("."+b.Carousel.CssClasses.item,this.contentEl);e*=d.length;var f,g;a.DOM.setStyle(this.el,{top:a.DOM.windowScrollTop()+"px",width:c,
height:h});a.DOM.setStyle(this.contentEl,{width:e,height:h});e=0;for(f=d.length;e<f;e++)g=d[e],a.DOM.setStyle(g,{width:c,height:h}),g=a.DOM.find("img",g)[0],a.isNothing(g)||this.resetImagePosition(g);this.setContentLeftPosition()},resetImagePosition:function(c){if(!a.isNothing(c)){a.DOM.getAttribute(c,"src");var b,e,d,f=a.DOM.width(this.el),g=a.DOM.height(this.el);this.settings.imageScaleMethod==="fitNoUpscale"?(e=c.naturalWidth,d=c.naturalHeight,e>f&&(b=f/e,e=Math.round(e*b),d=Math.round(d*b)),d>
g&&(b=g/d,d=Math.round(d*b),e=Math.round(e*b))):(b=c.isLandscape?f/c.naturalWidth:g/c.naturalHeight,e=Math.round(c.naturalWidth*b),d=Math.round(c.naturalHeight*b),this.settings.imageScaleMethod==="zoom"?(b=1,d<g?b=g/d:e<f&&(b=f/e),b!==1&&(e=Math.round(e*b),d=Math.round(d*b))):this.settings.imageScaleMethod==="fit"&&(b=1,e>f?b=f/e:d>g&&(b=g/d),b!==1&&(e=Math.round(e*b),d=Math.round(d*b))));a.DOM.setStyle(c,{position:"absolute",width:e,height:d,top:Math.round((g-d)/2)+"px",left:Math.round((f-e)/2)+
...
a.Events.add(c,b.Image.EventTypes.onError,this.imageErrorHandler);c.load()},slideCarousel:function(c,h,e){if(!this.isSliding){var f=a.DOM.windowWidth()+this.settings.margin,j,e=a.coalesce(e,this.settings.slideSpeed);if(!(d.Math.abs(j)<1)){switch(h){case a.TouchElement.ActionTypes.swipeLeft:c=f*-1;break;case a.TouchElement.ActionTypes.swipeRight:c=f;break;default:j=c.x-this.touchStartPoint.x,c=d.Math.abs(j)>f/2?j>0?f:f*-1:0}this.lastSlideByAction=c<0?b.Carousel.SlideByAction.next:c>0?b.Carousel.SlideByAction.previous:
...
a.DOM.appendToBody(this.captionEl);a.DOM.hide(this.captionEl);this.captionContentEl=a.DOM.createElement("div",{"class":b.Toolbar.CssClasses.captionContent},"");a.DOM.appendChild(this.captionContentEl,this.captionEl);this.addEventHandlers()},resetPosition:function(){var c,b;this.settings.captionAndToolbarFlipPosition?(c=a.DOM.windowScrollTop(),b=a.DOM.windowScrollTop()+a.DOM.windowHeight()-a.DOM.height(this.captionEl)):(c=a.DOM.windowScrollTop()+a.DOM.windowHeight()-a.DOM.height(this.toolbarEl),b=
a.DOM.windowScrollTop());a.DOM.setStyle(this.toolbarEl,{top:c+"px",width:a.DOM.windowWidth()});a.DOM.setStyle(this.captionEl,{top:b+"px",width:a.DOM.windowWidth()})},toggleVisibility:function(a){this.isVisible?this.fadeOut():this.show(a)},show:function(c){a.Animation.stop(this.toolbarEl);a.Animation.stop(this.captionEl);this.resetPosition();this.setToolbarStatus(c);a.Events.fire(this,{type:b.Toolbar.EventTypes.onBeforeShow,target:this});this.showToolbar();this.setCaption(c);this.showCaption();this.isVisible=
...
window.klass,window.Code.Util);(function(d,f,a){a.registerNamespace("Code.PhotoSwipe.UILayer");d.Code.PhotoSwipe.UILayer.CssClasses={uiLayer:"ps-uilayer"}})(window,window.klass,window.Code.Util);
...
") rotate("+c+"deg) translate("+f+"px, "+e+"px)";a.DOM.setStyle(this.transformEl,{webkitTransform:i,MozTransform:i,msTransform:i,transform:i});a.Events.fire(this,{target:this,type:b.ZoomPanRotate.EventTypes.onTransform,scale:this.transformSettings.scale,rotation:this.transformSettings.rotation,rotationDegs:c,translateX:f,translateY:e})}})})(window,window.klass,window.Code.Util);
(function(d,f){f.registerNamespace("Code.PhotoSwipe");var a=d.Code.PhotoSwipe;a.CssClasses={buildingBody:"ps-building",activeBody:"ps-active"};a.EventTypes={onBeforeShow:"PhotoSwipeOnBeforeShow",onShow:"PhotoSwipeOnShow",onBeforeHide:"PhotoSwipeOnBeforeHide",onHide:"PhotoSwipeOnHide",onDisplayImage:"PhotoSwipeOnDisplayImage",onResetPosition:"PhotoSwipeOnResetPosition",onSlideshowStart:"PhotoSwipeOnSlideshowStart",onSlideshowStop:"PhotoSwipeOnSlideshowStop",onTouch:"PhotoSwipeOnTouch",onBeforeCaptionAndToolbarShow:"PhotoSwipeOnBeforeCaptionAndToolbarShow",
onCaptionAndToolbarShow:"PhotoSwipeOnCaptionAndToolbarShow",onBeforeCaptionAndToolbarHide:"PhotoSwipeOnBeforeCaptionAndToolbarHide",onCaptionAndToolbarHide:"PhotoSwipeOnCaptionAndToolbarHide",onToolbarTap:"PhotoSwipeOnToolbarTap",onBeforeZoomPanRotateShow:"PhotoSwipeOnBeforeZoomPanRotateShow",onZoomPanRotateShow:"PhotoSwipeOnZoomPanRotateShow",onBeforeZoomPanRotateHide:"PhotoSwipeOnBeforeZoomPanRotateHide",onZoomPanRotateHide:"PhotoSwipeOnZoomPanRotateHide",onZoomPanRotateTransform:"PhotoSwipeOnZoomPanRotateTransform"};
a.instances=[];a.activeInstance=null;a.setActivateInstance=function(b){if(!f.isNothing(a.activeInstance))throw"Code.PhotoSwipe.activateInstance: Unable to active instance as another instance is already active";a.activeInstance=b};a.unsetActivateInstance=function(){a.activeInstance=null};a.attach=function(b,c,d){var e,i;e=a.createInstance(b,c,d);c=0;for(d=b.length;c<d;c++)if(i=b[c],!f.isNothing(i.nodeType)&&i.nodeType===1)i.__photoSwipeClickHandler=a.onTriggerElementClick.bind(e),f.Events.remove(i,
"click",i.__photoSwipeClickHandler),f.Events.add(i,"click",i.__photoSwipeClickHandler);return e};if(d.jQuery)d.jQuery.fn.photoSwipe=function(b,c){return a.attach(this,b,c)};a.detatch=function(b){var c,d,e;c=0;for(d=b.originalImages.length;c<d;c++)e=b.originalImages[c],!f.isNothing(e.nodeType)&&e.nodeType===1&&(f.Events.remove(e,"click",e.__photoSwipeClickHandler),delete e.__photoSwipeClickHandler);a.disposeInstance(b)};a.createInstance=function(b,c,d){var e;if(f.isNothing(b))throw"Code.PhotoSwipe.attach: No images passed.";
if(!f.isLikeArray(b))throw"Code.PhotoSwipe.createInstance: Images must be an array of elements or image urls.";if(b.length<1)throw"Code.PhotoSwipe.createInstance: No images to passed.";c=f.coalesce(c,{});e=a.getInstance(d);if(f.isNothing(e))e=new a.PhotoSwipeClass(b,c,d),a.instances.push(e);else throw'Code.PhotoSwipe.createInstance: Instance with id "'+d+' already exists."';return e};a.disposeInstance=function(b){var c=a.getInstanceIndex(b);if(c<0)throw"Code.PhotoSwipe.disposeInstance: Unable to find instance to dispose.";
...
(function(d,f,a,b,c,h,e,i,j){a.registerNamespace("Code.PhotoSwipe");var g=d.Code.PhotoSwipe;g.PhotoSwipeClass=f({id:null,settings:null,isBackEventSupported:null,backButtonClicked:null,currentIndex:null,originalImages:null,mouseWheelStartTime:null,windowDimensions:null,cache:null,documentOverlay:null,carousel:null,uiLayer:null,toolbar:null,zoomPanRotate:null,windowOrientationChangeHandler:null,windowScrollHandler:null,windowHashChangeHandler:null,keyDownHandler:null,windowOrientationEventName:null,
...
doubleTapZoomLevel:2.5,getImageSource:g.Cache.Functions.getImageSource,getImageCaption:g.Cache.Functions.getImageCaption,getImageMetaData:g.Cache.Functions.getImageMetaData,cacheMode:g.Cache.Mode.normal};a.extend(this.settings,e);if(this.settings.preventHide)this.settings.backButtonHideEnabled=!1;this.cache=new b.CacheClass(c,this.settings)},show:function(b){var c,e;if(a.isNumber(b))this.currentIndex=b;else{this.currentIndex=-1;c=0;for(e=this.originalImages.length;c<e;c++)if(this.originalImages[c]===
b){this.currentIndex=c;break}}if(this.currentIndex<0||this.currentIndex>this.originalImages.length-1)throw"Code.PhotoSwipe.PhotoSwipeClass.show: Starting index out of range";this.windowDimensions=this.getWindowDimensions();g.setActivateInstance(this);a.DOM.addClass(d.document.body,g.CssClasses.buildingBody);this.createComponents();a.Events.fire(this,{type:g.EventTypes.onBeforeShow,target:this});this.documentOverlay.fadeIn(this.settings.fadeInSpeed,this.onDocumentOverlayFadeIn.bind(this))},getWindowDimensions:function(){return{width:a.DOM.windowWidth(),
height:a.DOM.windowHeight()}},createComponents:function(){this.documentOverlay=new c.DocumentOverlayClass(this.settings);this.carousel=new h.CarouselClass(this.cache,this.settings);this.uiLayer=new i.UILayerClass(this.settings);if(!this.settings.captionAndToolbarHide)this.toolbar=new e.ToolbarClass(this.cache,this.settings)},resetPosition:function(){var b=this.getWindowDimensions();if(!(b.width===this.windowDimensions.width&&b.height===this.windowDimensions.height))this.windowDimensions=b,this.destroyZoomPanRotate(),
...
"PhotoSwipe"+(new Date).getTime().toString(),d.location.hash=this.currentHistoryHashValue),a.Events.add(d,"hashchange",this.windowHashChangeHandler);this.settings.enableMouseWheel&&a.Events.add(d,"mousewheel",this.mouseWheelHandler);a.Events.add(this.uiLayer,a.TouchElement.EventTypes.onTouch,this.uiLayerTouchHandler);a.Events.add(this.carousel,h.EventTypes.onSlideByEnd,this.carouselSlideByEndHandler);a.Events.add(this.carousel,h.EventTypes.onSlideshowStart,this.carouselSlideshowStartHandler);a.Events.add(this.carousel,
h.EventTypes.onSlideshowStop,this.carouselSlideshowStopHandler);a.isNothing(this.toolbar)||(a.Events.add(this.toolbar,e.EventTypes.onTap,this.toolbarTapHandler),a.Events.add(this.toolbar,e.EventTypes.onBeforeShow,this.toolbarBeforeShowHandler),a.Events.add(this.toolbar,e.EventTypes.onShow,this.toolbarShowHandler),a.Events.add(this.toolbar,e.EventTypes.onBeforeHide,this.toolbarBeforeHideHandler),a.Events.add(this.toolbar,e.EventTypes.onHide,this.toolbarHideHandler))},removeEventHandlers:function(){a.Browser.iOS&&
...
a.Events.remove(d,"mousewheel",this.mouseWheelHandler);a.isNothing(this.uiLayer)||a.Events.remove(this.uiLayer,a.TouchElement.EventTypes.onTouch,this.uiLayerTouchHandler);a.isNothing(this.toolbar)||(a.Events.remove(this.carousel,h.EventTypes.onSlideByEnd,this.carouselSlideByEndHandler),a.Events.remove(this.carousel,h.EventTypes.onSlideshowStart,this.carouselSlideshowStartHandler),a.Events.remove(this.carousel,h.EventTypes.onSlideshowStop,this.carouselSlideshowStopHandler));a.isNothing(this.toolbar)||
(a.Events.remove(this.toolbar,e.EventTypes.onTap,this.toolbarTapHandler),a.Events.remove(this.toolbar,e.EventTypes.onBeforeShow,this.toolbarBeforeShowHandler),a.Events.remove(this.toolbar,e.EventTypes.onShow,this.toolbarShowHandler),a.Events.remove(this.toolbar,e.EventTypes.onBeforeHide,this.toolbarBeforeHideHandler),a.Events.remove(this.toolbar,e.EventTypes.onHide,this.toolbarHideHandler))},hide:function(){if(!this.settings.preventHide){if(a.isNothing(this.documentOverlay))throw"Code.PhotoSwipe.PhotoSwipeClass.hide: PhotoSwipe instance is already hidden";
...
this.carousel.onTouch(b.action,b.point);break;case a.TouchElement.ActionTypes.touchStart:case a.TouchElement.ActionTypes.touchMoveEnd:this.carousel.onTouch(b.action,b.point);break;case a.TouchElement.ActionTypes.tap:this.toggleToolbar();break;case a.TouchElement.ActionTypes.doubleTap:b.point.x-=a.DOM.windowScrollLeft();b.point.y-=a.DOM.windowScrollTop();var c=this.cache.images[this.currentIndex].imageEl,e=d.parseInt(a.DOM.getStyle(c,"top"),10),f=d.parseInt(a.DOM.getStyle(c,"left"),10),h=f+a.DOM.width(c),
c=e+a.DOM.height(c);if(b.point.x<f)b.point.x=f;else if(b.point.x>h)b.point.x=h;if(b.point.y<e)b.point.y=e;else if(b.point.y>c)b.point.y=c;this.createZoomPanRotate();this.isZoomActive()&&this.zoomPanRotate.zoomAndPanToPoint(this.settings.doubleTapZoomLevel,b.point);break;case a.TouchElement.ActionTypes.gestureStart:this.createZoomPanRotate()}a.Events.fire(this,{type:g.EventTypes.onTouch,target:this,point:b.point,action:b.action})},onCarouselSlideByEnd:function(b){this.currentIndex=b.cacheIndex;a.isNothing(this.toolbar)||
